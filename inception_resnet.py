...
def InceptionResNetV1Norm(input_shape=(160, 160, 3),
    ...
    #conv2d 2
    x = conv2d_bn(x, 64, 3, name=name_fmt('Conv2d_1b_3x3', 0))
    #max pool
    x = MaxPooling2D((2,2), 2, name=name_fmt('MaxPool_1a_2x2', 0))(x)
    x = conv2d_bn(x, 80, 1, padding='valid', name=name_fmt('Conv2d_1a_1x1', 0))
    x = conv2d_bn(x, 192, 3, padding='valid', name=name_fmt('Conv2d_1c_3x3', 0))
    x = conv2d_bn(x, 256, 3, padding='valid', name=name_fmt('Conv2d_1d_3x3', 0))
